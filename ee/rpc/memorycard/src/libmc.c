...
static int libmc_rpc_open(const libmc_target_desc_t *target, const char *name, int mode)
{
	...
	strlcpy(target->m_interface_data->m_name_desc_param.m_name_param.m_name, name, sizeof(target->m_interface_data->m_name_desc_param.m_name_param.m_name));
...
static int libmc_rpc_chdir(const libmc_target_desc_t *target, const char* newDir, char* currentDir)
{
	...
	strlcpy(target->m_interface_data->m_name_desc_param.m_name_param.m_name, newDir, sizeof(target->m_interface_data->m_name_desc_param.m_name_param.m_name));
...
static int libmc_rpc_get_ent_space(const libmc_target_desc_t *target, const char* path)
{
	...
	target->m_interface_data->m_name_desc_param.m_name_param.m_port = target->m_port;
	target->m_interface_data->m_name_desc_param.m_name_param.m_slot = target->m_slot;
	strlcpy(target->m_interface_data->m_name_desc_param.m_name_param.m_name, path, sizeof(target->m_interface_data->m_name_desc_param.m_name_param.m_name));
...
static int libmc_rpc_rename(const libmc_target_desc_t *target, const char* oldName, const char* newName)
{
	...
	target->m_interface_data->m_name_desc_param.m_name_param.m_mcT = &(target->m_interface_data->m_extra_send_recv_param.m_file_info_buff);
	strlcpy(target->m_interface_data->m_name_desc_param.m_name_param.m_name, oldName, sizeof(target->m_interface_data->m_name_desc_param.m_name_param.m_name));
	strlcpy((char*)target->m_interface_data->m_extra_send_recv_param.m_file_info_buff.EntryName, newName, sizeof(target->m_interface_data->m_extra_send_recv_param.m_file_info_buff.EntryName));
	FlushCache(0);
